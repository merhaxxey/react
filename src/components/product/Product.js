...
import { getProduct, getSimilarProduct } from '../../features/product/productSlice'
...
const Product = ()=>{
    ...
    const {product, similarProduct, reviewsPerRatingLevel, reviewUserName} = useSelector((store)=> store.product)
    ...
    return <div  id='product-id' className='product'>
            ...
            <div className='customer-review-and-rating'>
                ...
                <article className='reviews-wrapper'>
                    <div className='review-buttons'>
                        ...
                        <Link onClick={()=> setWriteReview()} className='create-reviews' to='/product/review/create'>Write a review</Link>
                    </div>
        ...
        {/* <WriteAReview writeReview={writeReview}/> */}
    </div>
}
